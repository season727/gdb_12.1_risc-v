...
#define __GMP_CFLAGS "-Os -pipe -fno-caller-saves -fno-plt -mcmodel=medany -mabi=lp64d -march=rv64gcxthead -fno-caller-saves -fno-plt  -Wformat -Werror=format-security -D_FORTIFY_SOURCE=2 -Wl,-z,now -Wl,-z,relro -DPIC -fpic "
